 ...
 * longer than ten seconds — and `~/specs/windwalker/lib` says where that number comes from. It decides
		...
		<Section id="sef" title={t('sef.title')}>
			...
			<div className="mt-5 flex flex-col gap-3.5">
				...
				{/* What the uptime figure is a share of, said on the page because a reader cannot be expected
				    ...
				    rule and refused — see the note beside `sefDoubleMs` in `~/specs/windwalker/lib`. */}
